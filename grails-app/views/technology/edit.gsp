...
<html>
    ...
    <body>
        <div class="nav">
            ...
            <span class="menuButton"><g:link class="show" action="show" id="${technologyInstance.id}">"${technologyInstance.name}" Technology</g:link></span>
                        ...
                        <tbody>
                        	...
                        	<tr>
                        		<td colspan="10" class="bottomWrapperNoBorders">
					                <div class="buttons">
					                    	<span class="button"><g:actionSubmit class="save" action="update" value="Save Technology" /></span>
				                	</div>
				                </td>
			                </tr>
                        </tbody>
